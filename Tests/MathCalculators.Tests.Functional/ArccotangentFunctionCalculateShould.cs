...
namespace MathCalculators.Tests.Functional
{
    public class ArccotangentFunctionCalculateShould
    {
        ...
        public void SuccessfullyCalculateArccotangentOfPositiveAngle()
        {
            ...
            Assert.Equal("Specify angle to find the arccotangent of.", phase.Description);
            ...
            Assert.Collection(function.CurrentResult,
                i =>
                {
                    ...
                    Assert.Equal(1.0 / Math.Atan(value), TypeConverter.ToObject<double>(i.Value));
                });
        }
        ...
        public void SuccessfullyCalculateArccotangentWithNoAngleSpecified()
        {
            ...
            Assert.Collection(function.CurrentResult,
                i =>
                {
                    ...
                    Assert.Equal(1.0 / Math.Atan(0.0), TypeConverter.ToObject<double>(function.CurrentResult[0].Value));
                });
        }
    }
}
